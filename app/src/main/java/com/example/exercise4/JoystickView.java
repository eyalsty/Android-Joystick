...
public class JoystickView extends SurfaceView implements SurfaceHolder.Callback, View.OnTouchListener
{
    ...
    public JoystickView(Context context)
    {
        ...
        //cause the SurfaceView to use the onTouch method from this class to handle user screen touches from now on
    ...
    {
        /*This if statement prevents the drawing method from executing when
         the SurfaceView has not been created on-screen, preventing exceptions at runtime */
    ...
    {
        Log.d("create","inside joystick surfaceCreated()");
        setupDimensions();
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        Log.d("change","inside joystick surfaceChanged()");
        setupDimensions();
        drawJoystick(centerX, centerY);
    }
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        Log.d("surface destroy","inside joystick surfaceDestroyed()");
    }
        ...
        if(v.equals(this))
        {
            if(e.getAction() != e.ACTION_UP)
            {
                ...
                if(displacement < baseRadius)
                {
                    ...
                    joystickCallback.onJoystickMoved((e.getX() - centerX)/baseRadius, (centerY - e.getY())/baseRadius, getId());
                }
                else
                {
                    ...
                    joystickCallback.onJoystickMoved((constrainedX-centerX)/baseRadius, (centerY-constrainedY)/baseRadius, getId());
                }
            }
            else {
                drawJoystick(centerX, centerY);
